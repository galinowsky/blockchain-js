...
Blockchain.prototype.createNewBlock = function (nonce, previousBlockHash, hash) {
    ...
    const newBlock = {
        ...
        nonce,     //proof that we created new block from proof of work
        hash,
        previousBlockHash
    };
...
Blockchain.prototype.chainIsValid = function (blockchain) {
    ...
    const correctTransacrions = genesisBlock.transactions.length === 0;

    if (!(correctNonce && correctPreviousBlockHash && correctHash && correctTransacrions)) validChain = false
    return validChain
};
